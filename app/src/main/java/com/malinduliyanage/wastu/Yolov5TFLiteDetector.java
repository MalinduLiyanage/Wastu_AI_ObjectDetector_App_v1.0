...
public class Yolov5TFLiteDetector {
    ...
    float DETECT_THRESHOLD = 0.00f;
    float IOU_THRESHOLD = 0.00f;
    float IOU_CLASS_DUPLICATED_THRESHOLD = 0.00f;
    ...
    public void initialModel(Context activity, Float detectThreshold, Float iouThreshold, Float iouclassDuplicatedThreshold) {
        try {
            ...
            IOU_CLASS_DUPLICATED_THRESHOLD = iouclassDuplicatedThreshold;
